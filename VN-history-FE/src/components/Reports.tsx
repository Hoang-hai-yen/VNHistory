    ...
    <div className="reports-page">
      ...
      <div className="report-detail">
        <div className="detail-header">
          <h2 className="detail-title gold-text">Chi tiết báo cáo #BC-2026-0341</h2>
        ...
        <div className="info-grid">
          <div className="info-box"><label>TRẠNG THÁI</label><span className="tag-new">Mới</span></div>
          <div className="info-box"><label>MỨC ĐỘ</label><span className="tag-urgent">Nghiêm trọng</span></div>
          <div className="info-box"><label>LOẠI LỖI</label><span>Ngày tháng sai</span></div>
          <div className="info-box"><label>GỬI LÚC</label><span>28/03/2026</span></div>
        </div>
        ...
        <section className="detail-section">
          <label className="gold-text">ĐOẠN NỘI DUNG BỊ LỖI (NGƯỜI DÙNG TRÍCH DẪN)</label>
          <blockquote className="error-quote">
            "Ngô Quyền lãnh đạo quân dân đánh tan quân Nam Hán vào mùa xuân năm <span className="highlight-red">936</span>, kết thúc hơn 1.000 năm Bắc thuộc..."
          </blockquote>
        </section>
        ...
        <section className="detail-section">
          ...
          <p className="user-comment">
            Năm ghi trong bài là 936 nhưng trận Bạch Đằng thực sự diễn ra vào năm 938, không phải 936. 
            Sai lệch 2 năm nhưng đây là sự kiện quan trọng, cần sửa lại ngay.
          </p>
        </section>

        <section className="detail-section">
          <label className="gold-text">NGUỒN THAM KHẢO NGƯỜI DÙNG CUNG CẤP</label>
          <div className="source-box">Đại Việt Sử Ký Toàn Thư — Quyển V, Kỷ nhà Ngô, trang 112</div>
        </section>

        <div className="sender-grid">
          <div className="info-box"><label>NGƯỜI GỬI</label><span>Ẩn danh</span></div>
          <div className="info-box"><label>EMAIL</label><span className="blue-text">nguyen.t@gmail.com</span></div>
          <div className="info-box"><label>SỐ BÁO CÁO ĐÃ GỬI</label><span>3</span></div>
          <div className="info-box"><label>ĐỘ TIN CẬY</label><span className="green-text">Cao (2/3 đúng)</span></div>
        </div>
